...
import { ConnectToPosition, GetWirePosFromGatePos1, GetWirePosFromGatePos2 } from "@/utils";
...
export const useObjectsSlice = create(set => ({
  ...
  LINES: [
    ...
    //   to: { gateId: '', pin: 'in_A' },
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 6).out_Q
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 6).in_B
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 6).in_A
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   to: { gateId: '', pin: 'in_A' },
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 5).out_Q
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 5).in_B
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 5).in_A
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   to: { gateId: '', pin: 'in_A' },
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 4).out_Q
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 4).in_B
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 4).in_A
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   to: { gateId: '', pin: 'in_A' },
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 1).out_Q
    //   ]
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 1).in_B
    //   ],
    // },
    // {
    //   id: generateUUID(),
    ...
    //   positions: [
    //     ...GetWirePosFromGatePos1(0, 0, 1).in_A
    //   ],
    // },
    // {
    //   id: generateUUID(),
