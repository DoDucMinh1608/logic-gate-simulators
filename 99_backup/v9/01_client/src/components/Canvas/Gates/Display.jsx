...
function Display({ id, name, outputs, inputs, ...props }) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh position={[0, 0.625, 0]}>
        <boxGeometry args={[2.9, 1.25, 2.9]} />
        <meshStandardMaterial color={GATE_COLORS} roughness={0.7} metalness={0.2} />
        {/* Đường viền Neon chạy dọc khung */}
        <Edges threshold={15} lineWidth={3} color={isActive ? "#00ffcc" : "#3f475c"} />
      </mesh>
      ...
      {outQ
        ...
        : <NotIndicator position={[1.5, 0.125, 0]} />}
      {inA
        ? <mesh position={[-1.5, 0.125, 0]}>
          <boxGeometry args={[0.4, 0.3, 0.3]} />
          <meshStandardMaterial
